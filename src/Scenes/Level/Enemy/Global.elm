module Scenes.Level.Enemy.Global exposing (getLayerT)
...
import Scenes.Level.Enemy.Common exposing (EnvC, nullModel)
import Scenes.Level.Enemy.Export exposing (Data)
