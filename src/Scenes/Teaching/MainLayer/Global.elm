module Scenes.Teaching.MainLayer.Global exposing (getLayerT)
...
import Scenes.Teaching.LayerSettings exposing (LayerDataType(..), LayerT)
import Scenes.Teaching.MainLayer.Common exposing (EnvC, nullModel)
import Scenes.Teaching.MainLayer.Export exposing (Data)
